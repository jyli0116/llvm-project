...
; RUN: llc -mtriple=aarch64_be-unknown-linux-gnu -global-isel=1 -global-isel-abort=0 < %s | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-GI
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_base:
...
; CHECK-BE-SD-NEXT:    smull2 v0.4s, v0.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_base:
...
; CHECK-BE-GI-NEXT:    smull2 v0.4s, v0.8h, v1.8h
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcasta1:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
...
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcasta1:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcastb1:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
...
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcastb1:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev16 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    smull2 v0.4s, v0.8h, v1.8h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcasta2:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
...
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcasta2:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    rev64 v0.4h, v0.4h
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcastb2:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcastb2:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
...
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcasta1_wrongindex:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #4
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcasta1_wrongindex:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #4
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcastb1_wrongindex:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #6
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcastb1_wrongindex:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
...
; CHECK-BE-GI-NEXT:    rev16 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v0.16b, #6
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcasta2_wrongindex:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcasta2_wrongindex:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
...
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #4
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    rev32 v0.4h, v0.4h
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_bitcastb2_wrongindex:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #4
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_bitcastb2_wrongindex:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v0.16b, #4
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_splata1:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    smull2 v0.4s, v1.8h, v0.h[3]
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_splata1:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    smull v0.4s, v1.4h, v0.h[3]
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_splatb1:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    smull2 v0.4s, v0.8h, v1.h[3]
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_splatb1:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
...
; CHECK-BE-GI-NEXT:    rev16 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.h[3]
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_splata2:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    dup v0.2s, v0.s[3]
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    rev32 v0.4h, v0.4h
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_splata2:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    dup v0.2s, v0.s[3]
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    rev32 v0.4h, v0.4h
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_smull_high_s16_splatb2:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    dup v1.8b, v1.b[3]
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-SD-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_smull_high_s16_splatb2:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    dup v1.8b, v1.b[3]
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-GI-NEXT:    smull v0.4s, v0.4h, v1.4h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_umull_high_s16_bitcasta1:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    umull2 v0.4s, v0.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_umull_high_s16_bitcasta1:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    umull2 v0.4s, v0.8h, v1.8h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_vabdl_high_u82:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.16b, v0.16b
; CHECK-BE-SD-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    uabdl2 v0.8h, v0.16b, v1.16b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_vabdl_high_u82:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
...
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev16 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    uabdl2 v0.8h, v0.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_vabdl_high_s82:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.16b, v0.16b
; CHECK-BE-SD-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    sabdl2 v0.8h, v0.16b, v1.16b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_vabdl_high_s82:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-GI-NEXT:    rev64 v0.16b, v0.16b
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev16 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    sabdl2 v0.8h, v0.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_vqdmlal_high_s16_bitcast:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.8h, v1.8h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
...
; CHECK-BE-SD-NEXT:    sqdmlal2 v0.4s, v1.8h, v2.8h
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_vqdmlal_high_s16_bitcast:
; CHECK-BE-GI:       // %bb.0: // %entry
...
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    rev16 v2.16b, v2.16b
; CHECK-BE-GI-NEXT:    sqdmlal2 v0.4s, v1.8h, v2.8h
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_pmull_high_p8_128:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    fmov d0, x3
; CHECK-BE-SD-NEXT:    fmov d1, x1
; CHECK-BE-SD-NEXT:    rev64 v0.8b, v0.8b
; CHECK-BE-SD-NEXT:    rev64 v1.8b, v1.8b
; CHECK-BE-SD-NEXT:    pmull v0.8h, v1.8b, v0.8b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_pmull_high_p8_128:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    mov v0.d[0], x1
; CHECK-BE-GI-NEXT:    mov v1.d[0], x3
; CHECK-BE-GI-NEXT:    mov v0.d[1], x0
; CHECK-BE-GI-NEXT:    mov v1.d[1], x2
; CHECK-BE-GI-NEXT:    rev64 v0.16b, v0.16b
; CHECK-BE-GI-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    pmull2 v0.8h, v0.16b, v1.16b
; CHECK-BE-GI-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_pmull_high_p8_64:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v0.16b, v0.16b
; CHECK-BE-SD-NEXT:    rev64 v1.16b, v1.16b
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    pmull2 v0.8h, v0.16b, v1.16b
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_pmull_high_p8_64:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v0.16b, v0.16b
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: foov8i16:
; CHECK-BE-SD:       // %bb.0:
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    rev64 v1.4s, v1.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    shrn v0.4h, v0.4s, #5
; CHECK-BE-SD-NEXT:    shrn2 v0.8h, v1.4s, #5
; CHECK-BE-SD-NEXT:    rev64 v0.8h, v0.8h
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-BE-GI-NEXT:    shrn v1.4h, v1.4s, #5
; CHECK-BE-GI-NEXT:    rev64 v1.4h, v1.4h
; CHECK-BE-GI-NEXT:    shrn v0.4h, v0.4s, #5
; CHECK-BE-GI-NEXT:    rev64 v0.4h, v0.4h
; CHECK-BE-GI-NEXT:    fmov x8, d1
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: hadd32_zext_asr:
; CHECK-BE-SD:       // %bb.0:
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ushll2 v0.2d, v0.4s, #1
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: hadd32_zext_asr:
; CHECK-BE-GI:       // %bb.0:
; CHECK-BE-GI-NEXT:    rev64 v0.16b, v0.16b
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    rev32 v0.16b, v0.16b
; CHECK-BE-GI-NEXT:    mov d0, v0.d[1]
; CHECK-BE-GI-NEXT:    ushll v0.2d, v0.2s, #1
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
...
; CHECK-LE-NEXT:    ret
;
; CHECK-BE-SD-LABEL: test_umull_high_s16_splata1:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    rev64 v1.4s, v1.4s
; CHECK-BE-SD-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-SD-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    umull2 v0.2d, v1.4s, v0.s[1]
; CHECK-BE-SD-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test_umull_high_s16_splata1:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    rev64 v1.4s, v1.4s
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ext v1.16b, v1.16b, v1.16b, #8
; CHECK-BE-GI-NEXT:    rev64 v0.4s, v0.4s
; CHECK-BE-GI-NEXT:    mov d1, v1.d[1]
; CHECK-BE-GI-NEXT:    umull v0.2d, v1.2s, v0.s[1]
; CHECK-BE-GI-NEXT:    ext v0.16b, v0.16b, v0.16b, #8
; CHECK-BE-GI-NEXT:    ret
entry:
