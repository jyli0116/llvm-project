...
; RUN: llc %s -mtriple=aarch64_be -mattr=+v8.3a,+fullfp16 -o - | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-SD
; RUN: llc %s -mtriple=aarch64_be -mattr=+v8.3a,+fullfp16 -global-isel=1 -global-isel-abort=0 -o - | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-GI
