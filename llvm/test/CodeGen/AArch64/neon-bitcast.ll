...
; RUN: llc -mtriple=aarch64-none-linux-gnu -global-isel=1 -global-isel-abort=0 -mattr=+neon -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK-GI,CHECK-GI-LE
; RUN: llc -mtriple=aarch64_be-none-linux-gnu -global-isel=1 -global-isel-abort=0 -mattr=+neon -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK-GI,CHECK-GI-BE
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: test_v8i8_to_v1i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: test_v4i16_to_v1i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: test_v2i32_to_v1i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: test_v2f32_to_v1i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: test_v1i64_to_v1i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ret
...
; CHECK-GI-BE-NEXT:    mov h1, v0.h[1]
; CHECK-GI-BE-NEXT:    fmov w8, s1
; CHECK-GI-BE-NEXT:    mov v0.s[1], w8
; CHECK-GI-BE-NEXT:    rev64 v0.2s, v0.2s
; CHECK-GI-BE-NEXT:    ret
...
; CHECK-BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: bitcast_i16_to_v2i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    fmov s1, w0
; CHECK-GI-LE-NEXT:    mov b0, v1.b[0]
; CHECK-GI-LE-NEXT:    mov v0.b[4], v1.b[1]
; CHECK-GI-LE-NEXT:    // kill: def $d0 killed $d0 killed $q0
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: bitcast_i16_to_v2i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    fmov s0, w0
; CHECK-GI-BE-NEXT:    rev16 v0.16b, v0.16b
; CHECK-GI-BE-NEXT:    mov b1, v0.b[0]
; CHECK-GI-BE-NEXT:    mov v1.b[4], v0.b[1]
