...
; RUN: llc < %s -mtriple=aarch64-- -global-isel=1 | FileCheck %s --check-prefixes=CHECK-GI,CHECK-GI-LE
; RUN: llc < %s -mtriple=aarch64_be-- -global-isel=1 -global-isel-abort=0 | FileCheck %s --check-prefixes=CHECK-GI,CHECK-GI-BE
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i16_to_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    strh w0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i16_to_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    rev w8, w0
; CHECK-GI-BE-NEXT:    lsr w8, w8, #16
; CHECK-GI-BE-NEXT:    strh w8, [x1]
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i16_to_i8_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    strh w0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i16_to_i8_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    rev w8, w0
; CHECK-GI-BE-NEXT:    lsr w8, w8, #16
; CHECK-GI-BE-NEXT:    strh w8, [x1]
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i16_to_i8_offset:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    rev w8, w0
; CHECK-GI-LE-NEXT:    lsr w8, w8, #16
; CHECK-GI-LE-NEXT:    sturh w8, [x1, #11]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i16_to_i8_offset:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    sturh w0, [x1, #11]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i16 %x, 8
  %t0 = trunc i16 %x to i8
  %t1 = trunc i16 %sh1 to i8
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i16_to_i8_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    rev w8, w0
; CHECK-GI-LE-NEXT:    lsr w8, w8, #16
...
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i16_to_i8_order:
; CHECK-GI-BE:       // %bb.0:
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i32_to_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str w0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i32_to_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    rev w8, w0
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i32_to_i8_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str w0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i32_to_i8_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    rev w8, w0
; CHECK-GI-BE-NEXT:    str w8, [x1]
; CHECK-GI-BE-NEXT:    ret
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i32_to_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    rev w8, w0
; CHECK-GI-LE-NEXT:    str w8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i32_to_i8:
; CHECK-GI-BE:       // %bb.0:
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i32_to_i8_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    rev w8, w0
; CHECK-GI-LE-NEXT:    str w8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i32_to_i8_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str w0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i32 %x, 8
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i32_to_i16:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str w0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i32_to_i16:
; CHECK-GI-BE:       // %bb.0:
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i32_to_i16_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str w0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i32_to_i16_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ror w8, w0, #16
; CHECK-GI-BE-NEXT:    str w8, [x1]
; CHECK-GI-BE-NEXT:    ret
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i32_to_i16:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ror w8, w0, #16
; CHECK-GI-LE-NEXT:    str w8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i32_to_i16:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str w0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i32 %x, 16
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i32_to_i16_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ror w8, w0, #16
; CHECK-GI-LE-NEXT:    str w8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i32_to_i16_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str w0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i32 %x, 16
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i64_to_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str x0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i64_to_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    rev x8, x0
; CHECK-GI-BE-NEXT:    str x8, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 8
  %sh2 = lshr i64 %x, 16
  %sh3 = lshr i64 %x, 24
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i64_to_i8_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str x0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i64_to_i8_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    rev x8, x0
; CHECK-GI-BE-NEXT:    str x8, [x1]
; CHECK-GI-BE-NEXT:    ret
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i64_to_i8:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    rev x8, x0
; CHECK-GI-LE-NEXT:    str x8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i64_to_i8:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str x0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 8
  %sh2 = lshr i64 %x, 16
  %sh3 = lshr i64 %x, 24
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i64_to_i8_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    rev x8, x0
; CHECK-GI-LE-NEXT:    str x8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i64_to_i8_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str x0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 8
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i64_to_i16:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str x0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i64_to_i16_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str x0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i64_to_i16_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    lsr x8, x0, #16
; CHECK-GI-BE-NEXT:    lsr x9, x0, #48
; CHECK-GI-BE-NEXT:    lsr x10, x0, #32
; CHECK-GI-BE-NEXT:    strh w0, [x1]
; CHECK-GI-BE-NEXT:    strh w8, [x1, #2]
; CHECK-GI-BE-NEXT:    strh w9, [x1, #6]
; CHECK-GI-BE-NEXT:    strh w10, [x1, #4]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 16
  %sh2 = lshr i64 %x, 32
  %sh3 = lshr i64 %x, 48
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i64_to_i16:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ror w8, w0, #16
; CHECK-GI-LE-NEXT:    lsr x9, x0, #32
; CHECK-GI-LE-NEXT:    lsr x10, x0, #48
; CHECK-GI-LE-NEXT:    str w8, [x1, #4]
; CHECK-GI-LE-NEXT:    strh w9, [x1, #2]
; CHECK-GI-LE-NEXT:    strh w10, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i64_to_i16:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str x0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 16
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i64_to_i16_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    lsr x8, x0, #48
; CHECK-GI-LE-NEXT:    lsr x9, x0, #32
; CHECK-GI-LE-NEXT:    lsr x10, x0, #16
; CHECK-GI-LE-NEXT:    strh w0, [x1, #6]
; CHECK-GI-LE-NEXT:    strh w8, [x1]
; CHECK-GI-LE-NEXT:    strh w9, [x1, #2]
; CHECK-GI-LE-NEXT:    strh w10, [x1, #4]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i64_to_i16_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str x0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 16
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i64_to_i32:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str x0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i64_to_i32:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ror x8, x0, #32
; CHECK-GI-BE-NEXT:    str x8, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 32
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: le_i64_to_i32_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    str x0, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: le_i64_to_i32_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    ror x8, x0, #32
; CHECK-GI-BE-NEXT:    str x8, [x1]
; CHECK-GI-BE-NEXT:    ret
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i64_to_i32:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ror x8, x0, #32
; CHECK-GI-LE-NEXT:    str x8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i64_to_i32:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str x0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 32
...
; BE-NEXT:    ret
;
; CHECK-GI-LE-LABEL: be_i64_to_i32_order:
; CHECK-GI-LE:       // %bb.0:
; CHECK-GI-LE-NEXT:    ror x8, x0, #32
; CHECK-GI-LE-NEXT:    str x8, [x1]
; CHECK-GI-LE-NEXT:    ret
;
; CHECK-GI-BE-LABEL: be_i64_to_i32_order:
; CHECK-GI-BE:       // %bb.0:
; CHECK-GI-BE-NEXT:    str x0, [x1]
; CHECK-GI-BE-NEXT:    ret
  %sh1 = lshr i64 %x, 32
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: i64_to_i32_wrong_addr:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr x8, x0, #32
; CHECK-GI-NEXT:    str w0, [x1]
; CHECK-GI-NEXT:    str w8, [x1, #12]
; CHECK-GI-NEXT:    ret
  %sh1 = lshr i64 %x, 32
  %t0 = trunc i64 %x to i32
  %t1 = trunc i64 %sh1 to i32
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: i64_to_i16_wrong_order:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr x8, x0, #48
; CHECK-GI-NEXT:    lsr x9, x0, #16
; CHECK-GI-NEXT:    lsr x10, x0, #32
; CHECK-GI-NEXT:    strh w0, [x1]
; CHECK-GI-NEXT:    strh w8, [x1, #6]
; CHECK-GI-NEXT:    strh w9, [x1, #4]
; CHECK-GI-NEXT:    strh w10, [x1, #2]
; CHECK-GI-NEXT:    ret
  %sh1 = lshr i64 %x, 16
  %sh2 = lshr i64 %x, 32
  %sh3 = lshr i64 %x, 48
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: i32_to_i8_incomplete:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr w8, w0, #16
; CHECK-GI-NEXT:    lsr w9, w0, #24
; CHECK-GI-NEXT:    strb w0, [x1]
; CHECK-GI-NEXT:    strb w8, [x1, #2]
; CHECK-GI-NEXT:    strb w9, [x1, #3]
; CHECK-GI-NEXT:    ret
  %sh1 = lshr i32 %x, 8
  %sh2 = lshr i32 %x, 16
  %sh3 = lshr i32 %x, 24
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: i64_to_i8_incomplete:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr x8, x0, #56
; CHECK-GI-NEXT:    lsr x9, x0, #48
; CHECK-GI-NEXT:    lsr x10, x0, #40
; CHECK-GI-NEXT:    strb w0, [x1, #7]
; CHECK-GI-NEXT:    strb w8, [x1]
; CHECK-GI-NEXT:    lsr x8, x0, #32
; CHECK-GI-NEXT:    strb w9, [x1, #1]
; CHECK-GI-NEXT:    lsr x9, x0, #16
; CHECK-GI-NEXT:    strb w10, [x1, #2]
; CHECK-GI-NEXT:    lsr x10, x0, #8
; CHECK-GI-NEXT:    strb w8, [x1, #3]
; CHECK-GI-NEXT:    strb w9, [x1, #5]
; CHECK-GI-NEXT:    strb w10, [x1, #6]
; CHECK-GI-NEXT:    ret
  %sh1 = lshr i64 %x, 8
  %sh2 = lshr i64 %x, 16
  %sh3 = lshr i64 %x, 24
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: i32_to_i16_wrong_addr:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr w8, w0, #16
; CHECK-GI-NEXT:    strh w0, [x1]
; CHECK-GI-NEXT:    strh w8, [x1, #4]
; CHECK-GI-NEXT:    ret
  %sh1 = lshr i32 %x, 16
  %t0 = trunc i32 %x to i16
  %t1 = trunc i32 %sh1 to i16
...
; CHECK-NEXT:    ret
;
; CHECK-GI-LABEL: i32_to_i8_wrong_order:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr w8, w0, #24
; CHECK-GI-NEXT:    lsr w9, w0, #16
; CHECK-GI-NEXT:    lsr w10, w0, #8
; CHECK-GI-NEXT:    strb w0, [x1, #3]
; CHECK-GI-NEXT:    strb w8, [x1, #1]
; CHECK-GI-NEXT:    strb w9, [x1]
; CHECK-GI-NEXT:    strb w10, [x1, #2]
; CHECK-GI-NEXT:    ret
  %sh1 = lshr i32 %x, 8
  %sh2 = lshr i32 %x, 16
