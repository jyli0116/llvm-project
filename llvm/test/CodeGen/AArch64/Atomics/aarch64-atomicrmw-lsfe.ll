...
; RUN: llc %s -o - -verify-machineinstrs -mtriple=aarch64 -global-isel=0 -mattr=+lsfe -O0 | FileCheck %s --check-prefixes=CHECK,-O0
; RUN: llc %s -o - -verify-machineinstrs -mtriple=aarch64 -global-isel=0 -mattr=+lsfe -O1 | FileCheck %s --check-prefixes=CHECK,-O1
