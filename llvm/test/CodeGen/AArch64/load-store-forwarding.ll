...
; RUN: llc -mtriple=aarch64_be -global-isel=0 -o - %s | FileCheck %s --check-prefixes CHECK-BE,CHECK-BE-SD
; RUN: llc -mtriple=aarch64 -global-isel=1 -o - %s | FileCheck %s --check-prefixes CHECK-LE,CHECK-GI
; RUN: llc -mtriple=aarch64_be -global-isel=1 -global-isel-abort=0 -o - %s | FileCheck %s --check-prefixes CHECK-BE,CHECK-BE-GI
...
; CHECK-BE-SD:       // %bb.0:
; CHECK-BE-SD-NEXT:    mov w8, w0
; CHECK-BE-SD-NEXT:    lsr w0, w0, #24
; CHECK-BE-SD-NEXT:    str w8, [x1]
...
; CHECK-BE-GI:       // %bb.0:
; CHECK-BE-GI-NEXT:    str w0, [x1]
; CHECK-BE-GI-NEXT:    ldrb w0, [x1]
...
; CHECK-BE-SD:       // %bb.0:
; CHECK-BE-SD-NEXT:    str w0, [x1]
; CHECK-BE-SD-NEXT:    ret
;
; CHECK-BE-GI-LABEL: test4:
; CHECK-BE-GI:       // %bb.0:
; CHECK-BE-GI-NEXT:    str w0, [x1]
; CHECK-BE-GI-NEXT:    ldrb w0, [x1, #3]
; CHECK-BE-GI-NEXT:    ret
...
; CHECK-SD-NEXT:    ret
;
; CHECK-BE-SD-LABEL: load_i16_store_i8:
; CHECK-BE-SD:       // %bb.0: // %entry
; CHECK-BE-SD-NEXT:    ldrb w8, [x0, #1]
; CHECK-BE-SD-NEXT:    mov w0, wzr
; CHECK-BE-SD-NEXT:    strb w8, [x1]
; CHECK-BE-SD-NEXT:    ret
;
...
; CHECK-GI-NEXT:    ret
;
; CHECK-BE-GI-LABEL: load_i16_store_i8:
; CHECK-BE-GI:       // %bb.0: // %entry
; CHECK-BE-GI-NEXT:    ldrh w8, [x0]
; CHECK-BE-GI-NEXT:    mov w0, wzr
; CHECK-BE-GI-NEXT:    strb w8, [x1]
; CHECK-BE-GI-NEXT:    ret
entry:
