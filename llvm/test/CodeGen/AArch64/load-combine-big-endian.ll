...
; RUN: llc < %s -mtriple=aarch64_be-unknown | FileCheck %s --check-prefix=CHECK
; RUN: llc < %s -mtriple=aarch64_be-unknown -global-isel=1 -global-isel-abort=0  | FileCheck %s --check-prefix=CHECK-BE
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i32_by_i8_big_endian:
; CHECK-BE:       // %bb.0:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i32_by_i8_nonzero_offset:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldur w8, [x0, #1]
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i32_by_i8_neg_offset:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldur w8, [x0, #-4]
; CHECK-BE-NEXT:    rev w0, w8
; CHECK-BE-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i32_by_i8_nonzero_offset_bswap:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldur w0, [x0, #1]
; CHECK-BE-NEXT:    ret
  %tmp1 = getelementptr inbounds i8, ptr %arg, i32 4
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i32_by_i8_neg_offset_bswap:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldur w0, [x0, #-4]
; CHECK-BE-NEXT:    ret
  %tmp1 = getelementptr inbounds i8, ptr %arg, i32 -1
  %tmp2 = load i8, ptr %tmp1, align 1
  %tmp3 = zext i8 %tmp2 to i32
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i32_by_i8_base_offset_index_2:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    add x8, x0, w1, uxtw
; CHECK-BE-NEXT:    ldur w8, [x8, #13]
; CHECK-BE-NEXT:    rev w0, w8
; CHECK-BE-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: zext_load_i32_by_i8_shl_8:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldrb w8, [x0]
; CHECK-BE-NEXT:    ldrb w9, [x0, #1]
; CHECK-BE-NEXT:    lsl w8, w8, #8
; CHECK-BE-NEXT:    orr w0, w8, w9, lsl #16
; CHECK-BE-NEXT:    ret
  %tmp2 = load i8, ptr %arg, align 2
  %tmp3 = zext i8 %tmp2 to i32
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: zext_load_i32_by_i8_shl_16:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldrb w8, [x0]
; CHECK-BE-NEXT:    ldrb w9, [x0, #1]
; CHECK-BE-NEXT:    lsl w8, w8, #16
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: zext_load_i32_by_i8_bswap_shl_8:
; CHECK-BE:       // %bb.0:
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: zext_load_i32_by_i8_bswap_shl_16:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldrb w8, [x0, #1]
; CHECK-BE-NEXT:    ldrb w9, [x0]
; CHECK-BE-NEXT:    lsl w8, w8, #16
...
; CHECK-NEXT:    ret
;
; CHECK-BE-LABEL: load_i16_from_nonzero_offset:
; CHECK-BE:       // %bb.0:
; CHECK-BE-NEXT:    ldrh w8, [x0]
; CHECK-BE-NEXT:    ldrb w9, [x0, #2]
; CHECK-BE-NEXT:    orr w0, w9, w8, lsl #8
; CHECK-BE-NEXT:    ret
