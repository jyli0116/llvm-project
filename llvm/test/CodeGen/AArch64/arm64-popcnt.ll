...
; RUN: llc < %s -mtriple=aarch64_be-none-eabi | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-SD
; RUN: llc < %s -mtriple=aarch64_be-none-eabi -global-isel=1 -global-isel-abort=0 | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-GI
